      ...
      {hasDetail && (
        <Box sx={{ p: 3, "& h6": { mt: 3, mb: 1.5 }, "& p": { mb: 1.5 } }}>
          ...
          <Box component="ul" sx={{ pl: 2.5, m: 0 }}>
            ...
            <li>
              <strong>매트 운동:</strong> 소도구를 활용하여 척추 안정성과 전신
              근력을 향상시키는 다양한 매트 동작을 배웁니다.
            </li>
            <li>
              <strong>자세 교정:</strong> 일상생활에서 무너진 자세를 바로잡고,
              통증을 완화하는 데 도움이 되는 스트레칭과 운동법을 익힙니다.
            </li>
          </Box>
