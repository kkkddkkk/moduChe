        ...
        <Layout space={2} padding={3}>
            <Grid size={12}>
                <Box>
                    ...
                    - text 타입의 input <span style={{ fontWeight: "bold" }}>CustomTextField</span> 입니다. (props: padding, data, setData, disabled, placeholder)<br />
            ...
            <Grid size={12}>
                <CustomTextField
                    ...
                    data={textData}
                    setData={setTextData}
                    placeholder={"placeholder 사용. size=12"}
                />
            </Grid>
            <Grid size={6}>
                <CustomTextField
