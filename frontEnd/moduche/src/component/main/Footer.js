  ...
  return (
    ...
    >
      <MainTextContainer margin={'2% 0'}>
        <Link
          href={
            'https://www.kspo.or.kr/kspo/privacy/privacyPolicy/privacy_policy.do?menuNo=200438'
          }
        >
        ...
        <Link
          href={'https://www.kspo.or.kr/kspo/main/contents.do?menuNo=200218'}
        >
        ...
        <MainBar barColor={menuColor} />
        <Link
          href={'https://www.kspo.or.kr/kspo/main/contents.do?menuNo=200176'}
        >
          <MainMenu menuColor={menuColor}>전화번호안내</MainMenu>
        </Link>
        <MainBar barColor={menuColor} />
        <Link
          href={'https://www.kspo.or.kr/kspo/main/contents.do?menuNo=200207'}
        >
        ...
        <MainBar barColor={menuColor} />
        <Link
          href={'https://www.kspo.or.kr/kspo/main/contents.do?menuNo=200360'}
        >
